...
/*
    public static void customerAppointmntReport(){

        ScheduleScreen.textArea.setText("MONTH  |  TYPE  |  APPOINTMENT QUANTITY");
        ...
        try{
            ...
            for (int i1 = 0; i1 < startParsed.size(); i1++) {
                ...
                if(element1 != null){//basically a while not null
                    ...
                    activeYear = Integer.parseInt(java.time.LocalDate.now().toString().substring(0, 4));
                    if (Integer.parseInt(activeMonthStart) < (Integer.valueOf(activeMonthEnd))){
                    ...
                    for (int i2 = 0; i2 < typesParsed.size(); i2++) {
                        ...
                        while (rsR.next()) {
                            ...
                            ScheduleScreen.textArea.appendText(activeHRM + "   |   " + activeType + "   |   " + count);
        ...
        System.out.println(monthParsed);
        //typesParsed  startParsed  months
